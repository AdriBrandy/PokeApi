...
const Button2 = ({ text, url, id, className }) => {
    const handleClick = (e) => {
        if (id) {
          e.preventDefault();
        ...
        // Si no hay id, se comporta como un link normal (abrirá la URL)
      };
  return (
    <a
     href={url ?? "#"}
...
const StyledWrapper = styled.div`
  ...
  .outer-cont {
    ...
    box-shadow: inset 0px 0px 5px #ffffffa9, inset 0px 30px 30px #000,
